...
<div class="form-content">
	<form action="<?php echo $this->Html->url(array('controller' => 'FunctionCorps', 'action' => 'generateChangeOfCompanyName')); ?>" method="post" accept-charset="utf-8">
            ...
            <label>ShareHolder</label>
               ...
               <input class= "form-control" value="<?php echo $shareholder; ?>" name="shareholder[]"/>
                ...
                <div class="input text required">
                        ...
                        <input style="margin-bottom:10px" name="new_company_name" value="<?php echo $data['newCompanyName'] ?>" class="form-control" type="text"  required="required"/>
                </div>
		 <div class="input text required">
