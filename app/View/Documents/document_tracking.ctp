...
<br />
<form  action="<?php echo $this->Html->url(array('controller' => 'Documents', 'action' => 'trackingPage'))?>" method="post" accept-charset="utf-8">
<div class="input select required">
			
			<select name="company" class="form-control" id="company" required="required">
			...
			<select name="functionCorp" class="form-control" id="function" required="required">
