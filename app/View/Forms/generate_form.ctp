...
<br />
<form id="generate_form" action="<?php echo $this->Html->url(array('controller' => 'FunctionCorps', 'action' => '')); ?>" method="post" accept-charset="utf-8">
...
<h3>View | Edit last submissions</h3>
<br />
<form action="<?php echo $this->Html->url(array('controller' => 'FunctionCorps', 'action' => 'displayLastSubmissions')); ?>" method="post" accept-charset="utf-8">
<div class="input select required">
